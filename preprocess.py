...
def read_entity_from_id(filename='./data/countries_S1/entity2id.txt'):
    entity2id = {}
    ...
    return entity2id
def read_relation_from_id(filename='./data/countries_S1/relation2id.txt'):
    relation2id = {}
    with open(filename, 'r') as f:
        for line in f:
            if len(line.strip().split()) > 1:
...
def build_data(path='./data/umls/', is_unweigted=False, directed=True):
